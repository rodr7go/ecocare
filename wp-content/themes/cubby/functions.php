...
if ( ! function_exists( '_wp_render_title_tag' ) ) {
	function cubby_slug_render_title() {
?>
<title><?php wp_title( '|', true, 'right' ); ?></title>
<?php
	}
	add_action( 'wp_head', 'cubby_slug_render_title' );
}
...
////register styles & scripts
  function cubby_custom_scripts(){
	...
	wp_enqueue_script('cubby-default', CUBBY_THEME_BASE_URL.'/js/cubby.js', array("jquery"), '1.1.1', false);
	if ( is_singular() ){
	...
	wp_enqueue_style( 'cubby-main', get_stylesheet_uri(), array(), '1.1.1' );
	wp_enqueue_style('cubby-scheme', CUBBY_THEME_BASE_URL.'/styles/scheme.less', false, '1.1.1', false);
