...
class expert_licensing_page_class{
	...
	public function web_dorado_licensing_admin_scripts(){
		...
		wp_enqueue_style('web_dorado_licensing_admin_scripts',get_bloginfo('template_directory').'/admin/css/licensing.css');	
	}
...
<td>
<div class="buy_theme" style="float:left;"><a href="<?php echo $web_dor.'/wordpress-themes/exclusive.html'; ?>" target="_blank"><div></div></a></div>
</td>
</tr>
</tbody>
</table>
