...
$example_update_checker = new ThemeUpdateChecker(
	'Django',                                            //Theme folder name, AKA "slug". 
	'http://www.fabthemes.com/versions/django.json' //URL of the metadata file.
); 
...
function web2feel_scripts() {
	...
	wp_enqueue_script( 'ayaslider', get_template_directory_uri() . '/js/ayaslider.js', array( 'jquery' ), '20120206', true );
